...
import numpy as np
from Model.transformer.layers import multihead_attention,feedforward
from utils import *
...
class Model(nn.Module):
   ...
   #                                  )
	...
	def predict(self,user_rep,item_idx):
		...
		test_logits = test_logits.view(user_rep.shape[0],self.opt['max_seq_len'],item_idx.shape[0])
